...
RUN apk add --no-cache --repository http://dl-3.alpinelinux.org/alpine/edge/testing/ binutils boost-dev build-base cmake crypto++-dev gcc make mariadb-connector-c-dev curl-dev libcurl openssl-dev ossp-uuid-dev zlib-dev
