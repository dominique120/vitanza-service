...
RUN apk add --no-cache --repository http://dl-3.alpinelinux.org/alpine/edge/testing/ binutils boost-dev build-base cmake crypto++-dev gcc make mariadb-connector-c-dev libcurl4-openssl-dev libssl-dev uuid-dev zlib1g-dev libpulse-dev
